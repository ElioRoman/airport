...
export const getDepartureListSelector = createSelector([departureListSelector], dataList => {
  if (dataList) {
    return dataList
      .slice()
...
export const getArrivalListSelector = createSelector([arrivalListSelector], dataList => {
  if (dataList) {
    return dataList
      .slice()
